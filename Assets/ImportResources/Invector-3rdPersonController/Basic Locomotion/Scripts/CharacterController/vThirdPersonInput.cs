...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonInput : vMonoBehaviour, vIAnimatorMoveReceiver
    {
        ...
        private void Awake()
        {
            ...
            unlockCursorOnStart = true;
            showCursorOnStart = false;
        }
        ...
        {
            return !cc.customAction && !cc.isCrouching && cc.isGrounded && cc.GroundAngle() < cc.slopeLimit &&
        ...
        {
            if (SimpleInput.GetButtonDown("Jump") && JumpConditions())
            {
                cc.Jump(true);
                return;
            }
